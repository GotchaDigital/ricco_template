<header class="header mob-header cart-<?php echo $nz_h1_desk_shop_cart; ?> nz-clearfix">
...
<div class="mob-header-content nz-clearfix">
	...
	<div class="custom-scroll-bar">
		...
		<?php if (isset($GLOBALS['focuson_ninzio']['h1-desk-slogan']) && !empty($GLOBALS['focuson_ninzio']['h1-desk-slogan'])): ?>
			<div class="slogan nz-clearfix">
				<?php echo $GLOBALS['focuson_ninzio']['h1-desk-slogan']; ?>
			</div>
		<?php endif ?>

		<?php if(isset($GLOBALS['focuson_ninzio']["h1-top-button-text"]) && !empty($GLOBALS['focuson_ninzio']["h1-top-button-text"])): ?>
			<a class="top-button" href="<?php echo esc_url($GLOBALS['focuson_ninzio']["h1-top-button-url"]); ?>"><?php echo esc_attr($GLOBALS['focuson_ninzio']["h1-top-button-text"]); ?></a>
		<?php endif; ?>
			...
			<div class="container nz-clearfix">
				...
				<?php if (!empty($nz_h1_desk_logo)): ?>
					<div class="logo logo-desk">
						<a href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>">
							<img style="max-width:<?php echo $nz_h1_desk_logo_w; ?>px;max-height:<?php echo $nz_h1_desk_logo_h; ?>px;" src="<?php echo $nz_h1_desk_logo; ?>" alt="<?php bloginfo('name'); ?>">
						</a>
					</div>
				<?php else: ?>
					<div class="logo-title"><?php echo get_bloginfo('name') ?></div>
				...
				<?php if (!empty($nz_h1_desk_fixed_logo)): ?>
					<div class="logo logo-desk-fixed">
						<a href="<?php echo esc_url(home_url('/')); ?>" title="<?php bloginfo('name'); ?>">
							<img style="max-width:<?php echo $nz_h1_desk_fixed_logo_w; ?>px;max-height:<?php echo $nz_h1_desk_fixed_logo_h; ?>px;" src="<?php echo $nz_h1_desk_fixed_logo; ?>" alt="<?php bloginfo('name'); ?>">
						</a>
					</div>
				<?php endif ?>
